...
//# values in the order given. After constructing a binary tree - i. Insert new node, 
//#ii. Find number of nodes in longest path from root, iii. Minimum data value found in the tree,
